...
class SkillContractTests(unittest.TestCase):
    ...
    def test_decision_gate_privacy_and_package_audit_are_explicit(self):
        text = (SKILL_ROOT / "SKILL.md").read_text(encoding="utf-8")
        self.assertIn("Major Revision", text)
        self.assertIn("reviewer-facing response", text)
        self.assertIn("package-consistency.md", text)
